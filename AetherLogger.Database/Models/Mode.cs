...
public interface IMode : ISmartEnum
{
    string ReadableName { get; }
}

public abstract class ModeBase<TEnum>(string name, string? readableName = null) : SmartEnum<TEnum, int>(name, ++_counter), IMode where TEnum : SmartEnum<TEnum, int>
{
...
public sealed class Mode : ModeBase<Mode>
{
    ...
    public static readonly Mode ATV = new(nameof(ATV));
    public static readonly Mode CHIP = new(nameof(CHIP), ChipSubMode.List);
    public static readonly Mode CLO = new(nameof(CLO));
    public static readonly Mode CONTESTI = new(nameof(CONTESTI), "Contestia");
    public static readonly Mode CW = new(nameof(CW), "Morse (CW)", CwSubMode.List);
    public static readonly Mode DIGITALVOICE = new(nameof(DIGITALVOICE), "Digital Voice", DigitalVoiceSubMode.List);
    public static readonly Mode DOMINO = new(nameof(DOMINO), "Domino", DominoSubMode.List);
    public static readonly Mode DYNAMIC = new(nameof(DYNAMIC), "VARA (Dynamic)", DynamicSubMode.List);
    public static readonly Mode FAX = new(nameof(FAX), "Fax");
    public static readonly Mode FM = new(nameof(FM));
    public static readonly Mode FSK411 = new(nameof(FSK411));
    public static readonly Mode FT8 = new(nameof(FT8));
    public static readonly Mode HELL = new(nameof(HELL), "Hellschreiber", HellSubMode.List);
    public static readonly Mode ISCAT = new(nameof(ISCAT), "Ionospheric Scattering (ISCAT)", IscatSubMode.List);
    public static readonly Mode JT4 = new(nameof(JT4), Jt4SubMode.List);
    public static readonly Mode JT6M = new(nameof(JT6M));
    public static readonly Mode JT9 = new(nameof(JT9), Jt9SubMode.List);
    public static readonly Mode JT44 = new(nameof(JT44));
    public static readonly Mode JT65 = new(nameof(JT65), Jt65SubMode.List);
    public static readonly Mode MFSK = new(nameof(MFSK), MfskSubMode.List);
    public static readonly Mode MSK144 = new(nameof(MSK144));
    public static readonly Mode MT63 = new(nameof(MT63));
    public static readonly Mode OLIVIA = new(nameof(OLIVIA), "Olivia MFSK", OliviaSubMode.List);
    public static readonly Mode OPERA = new(nameof(OPERA), OperaSubMode.List);
    public static readonly Mode PAC = new(nameof(PAC), "PACTOR", PacSubMode.List);
    public static readonly Mode PAX = new(nameof(PAX), PaxSubMode.List);
    public static readonly Mode PKT = new(nameof(PKT), "Packet");
    public static readonly Mode PSK = new(nameof(PSK), PskSubMode.List);
    public static readonly Mode PSK2K = new(nameof(PSK2K));
    public static readonly Mode Q15 = new(nameof(Q15));
    public static readonly Mode QRA64 = new(nameof(QRA64), Qra64SubMode.List);
    public static readonly Mode ROS = new(nameof(ROS), RosSubMode.List);
    public static readonly Mode RTTY = new(nameof(RTTY), RttySubMode.List);
    public static readonly Mode RTTYM = new(nameof(RTTYM));
    public static readonly Mode SSB = new(nameof(SSB), SsbSubMode.List);
    public static readonly Mode SSTV = new(nameof(SSTV));
    public static readonly Mode T10 = new(nameof(T10));
    public static readonly Mode THOR = new(nameof(THOR), ThorSubMode.List);
    public static readonly Mode THRB = new(nameof(THRB), "THROB", ThrbSubMode.List);
    public static readonly Mode TOR = new(nameof(TOR), "(SI)TOR", TorSubMode.List);
    public static readonly Mode V4 = new(nameof(V4));
    public static readonly Mode VOI = new(nameof(VOI), "VOICE (Olivia)");
    public static readonly Mode WINMOR = new(nameof(WINMOR));
    public static readonly Mode WSPR = new(nameof(WSPR));

    public IEnumerable<IMode>? Submodes { get; }

    private Mode(string name, string? readableName = null, IEnumerable<IMode>? submodes = null) : base(name, readableName)
    {
        Submodes = submodes;
    }

    public Mode(string name, IEnumerable<IMode> submodes) : this(name, name, submodes)
    {
    }
}
